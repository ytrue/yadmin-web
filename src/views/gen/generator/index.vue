    ...
    <a-card>
        ...
        <div class="table-operator">
            ...
            <a-row class="row-item-search">
                <a-form class="search-form" :form="searchFrom" layout="inline">
                    ...
                    <a-form-item label="表名" refs="searchFromRefs">
                        <a-input placeholder="表名" v-decorator="['tableName',{initialValue:''}]"/>
                    </a-form-item>
        ...
        <div>
            ...
            <a-space class="operator">
                <a-button icon="form" type="primary" @click="addHandle()">新增</a-button>
    ...
    export default {
        ...
        methods: {
            ...
            init(type = "") {
                ...
                let searchParam = [
                    {column: 'table_name', type: 'like', value: this.searchFrom.getFieldValue('tableName')},
                ]
